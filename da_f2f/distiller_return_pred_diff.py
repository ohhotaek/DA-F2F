...
from da_f2f.utils import SaveIO, ManualSeed, ReplaceProposalsOnce, set_attributes
from da_f2f.pseudolabeler import PseudoLabeler
...
@DISTILLER_REGISTRY.register()
class DA_F2FDistiller(Distiller):
    ...
    @classmethod
    def from_config(cls, cfg, teacher, student):
        return DA_F2FDistiller(teacher, student,
...
# Any modifications to the torch module itself go here and are mixed in in rcnn.DA_F2F
